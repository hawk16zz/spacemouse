...
//              {  AX,   AY,   BX,   BY,   CX,   CY,   DX,   DY}
#define MINVALS {-499, -563, -534, -553, -532, -558, -456, -573}
#define MAXVALS {518, 454, 483, 464, 486, 459, 561, 444}
...
#define TRANSX_SENSITIVITY      5  // RJS:2.50  HJS:5.00
#define TRANSY_SENSITIVITY      5  // RJS:2.50  HJS:5.00
#define POS_TRANSZ_SENSITIVITY  8  // RJS:15.0  HJS:8.00
#define NEG_TRANSZ_SENSITIVITY  6  // RJS:7.00  HJS:6.00  I want low sensitivity for down, therefore a high value.
#define GATE_NEG_TRANSZ         8  // RJS:0.01  HJS:8.00  gate value, which negative z movements will be ignored (like an additional deadzone for -z).
#define GATE_ROTX               2     // RJS:1     HJS:2     value under which rotX values will be forced to zero
#define GATE_ROTY               2     // RJS:1     HJS:2     value under which roty values will be forced to zero
#define GATE_ROTZ               2     // RJS:1     HJS:2     value under which rotz values will be forced to zero
#define ROTX_SENSITIVITY        1.5  // RJS:0.75  HJS:1.50
#define ROTY_SENSITIVITY        1.5  // RJS:0.75  HJS:1.50
#define ROTZ_SENSITIVITY        3  // RJS:2.00  HJS:3.00
...
#define SLOPE_AT_ZERO 1.1  // RJS:1.15  HJS:1.10  exponent "a", recommended: 1.0 ... 3.0  [anything from linear to x^3]  -> bigger value flattens the curve more near zero (on MODFUNC 1 and 3)
...
#define INVRY 0  // Rotate around Y axis (tilt left/right)   RJS:1     HJS:0
#define INVRZ 0  // Rotate around Z axis (twist left/right)  RJS:1     HJS:0
...
#define COMP_ENABLED       1        // enable the compensation    RJS:0     HJS:1
